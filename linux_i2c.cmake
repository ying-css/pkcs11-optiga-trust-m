...
if(UNIX)
	...
	if(ENABLE_DEBUG)
		...
		target_compile_definitions(${TARGET_I2C_SHLIB} PRIVATE  -DPAL_OS_HAS_EVENT_INIT -DOPTIGA_LIB_EXTERNAL="${CMAKE_CURRENT_SOURCE_DIR}/config/optiga_trust_m_config.h" -DDEBUG -DOPTIGA_LIB_ENABLE_LOGGING -DHAS_LIBGPIOD -DPKCS11_SUPPORT_RSA)
	else()
		target_compile_definitions(${TARGET_I2C_SHLIB} PRIVATE  -DPAL_OS_HAS_EVENT_INIT -DOPTIGA_LIB_EXTERNAL="${CMAKE_CURRENT_SOURCE_DIR}/config/optiga_trust_m_config.h" -DHAS_LIBGPIOD -DPKCS11_SUPPORT_RSA)
	endif()
