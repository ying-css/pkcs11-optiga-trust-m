...
/**
 * @brief OID for curve NIST P-256.
 */
#define pkcs11DER_ENCODED_OID_P256 \
    { 0x06, 0x08, 0x2a, 0x86, 0x48, 0xce, 0x3d, 0x03, 0x01, 0x07 }

/**
 * @brief OID for curve NIST P-384.
 */
#define pkcs11DER_ENCODED_OID_P384 \
    { 0x06, 0x05, 0x2b, 0x81, 0x04, 0x00, 0x22 }

/**
 * @brief OID for curve NIST P-512.
 */
#define pkcs11DER_ENCODED_OID_P521 \
    { 0x06, 0x05, 0x2b, 0x81, 0x04, 0x00, 0x23 }

/**
 * @brief OID for curve Brainpool P-256. OID:1.3.132.0.35
 */
#define pkcs11DER_ENCODED_OID_BP256 \
    { 0x06, 0x09, 0x2B, 0x24, 0x03, 0x03, 0x02, 0x08, 0x01, 0x01, 0x07 }

/**
 * @brief OID for curve Brainpool P-384. OID:1.3.132.0.35
 */
#define pkcs11DER_ENCODED_OID_BP384 \
    { 0x06, 0x09, 0x2B, 0x24, 0x03, 0x03, 0x02, 0x08, 0x01, 0x01, 0x0B }

/**
 * @brief OID for curve Brainpool P-512. OID:1.3.36.3.3.2.8.1.1.13
 */
 ...
 * @brief Length of a curve P-521 ECDSA signature, in bytes.
 */
#define pkcs11ECDSA_BP512_SIGNATURE_LENGTH 128

/**
 * @brief Length of a curve P-256 ECDSA key, in bytes.
 */
#define pkcs11EC_P256_PUBLIC_KEY_LENGTH 68  // 0x44 = 68 = 64 + 4
/**
 * @brief Length of a curve P-384 ECDSA key, in bytes.
 */
#define pkcs11EC_P384_PUBLIC_KEY_LENGTH 100  // 0x64 = 100 = 96 + 4
/**
 * @brief Length of a curve P-521 ECDSA key, in bytes.
 */
#define pkcs11EC_P521_PUBLIC_KEY_LENGTH 137  // 0x89 = 137 = 128 + 5
